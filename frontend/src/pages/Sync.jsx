      ...
      <Card>
        ...
        <CardContent className="space-y-4 text-sm">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <Label htmlFor="ics-file" className="text-xs text-slate-500 dark:text-slate-400">
          ...
          <div className="space-y-2 border-t border-slate-100 dark:border-slate-700 pt-4">
            ...
            <textarea
              className="flex min-h-[140px] w-full rounded-md border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 px-3 py-2 text-sm text-slate-900 dark:text-slate-100 placeholder:text-slate-400 dark:placeholder:text-slate-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2"
